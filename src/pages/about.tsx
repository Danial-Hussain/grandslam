      ...
      <div className="p-4 flex flex-col gap-y-6 relative">
        ...
        <div className="flex flex-col gap-y-4 backdrop-blur-sm bg-gray-50 bg-opacity-10 h-full">
          ...
          <div className="text-md tracking-wide text-justify md:text-2xl">
            As a tennis fanatic myself, I&apos;ve always enjoyed following the
            ATP and WTA Grandslam tournaments (Vamos Rafa!). While match
            schedules and timings were always easy to find, I noticed the same
            couldn&apos;t be said for tournament brackets.
          </div>
          <div className="text-md tracking-wide text-justify md:text-2xl">
            Grandslam Bracket was created to solve this exact problem. You can
            easily relive tennis history through radial brackets spanning from
            the year 2000 to the present, for both ATP and WTA Grandslam
            tournaments. We&apos;ll be adding the latest tournaments as the
            events take place!
          </div>
          <div className="text-md tracking-wide text-justify md:text-2xl">
